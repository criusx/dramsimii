...
\item\contentsline{section}{{\bf DRAMsimII::Algorithm} (\doxyref{Algorithm}{p.}{class_d_r_a_msim_i_i_1_1_algorithm} specific data structures should go in here )}{\pageref{class_d_r_a_msim_i_i_1_1_algorithm}}{}
...
\item\contentsline{section}{{\bf DRAMsimII::BusEvent} (\doxyref{Event}{p.}{class_d_r_a_msim_i_i_1_1_event} that has happened on the memory bus )}{\pageref{class_d_r_a_msim_i_i_1_1_bus_event}}{}
...
\item\contentsline{section}{{\bf DRAMsimII::Queue$<$ T $>$} (\doxyref{Queue}{p.}{class_d_r_a_msim_i_i_1_1_queue} template class, rhs circular queue  push/pop are O(1) operations, while random insertions are O(n) operations )}{\pageref{class_d_r_a_msim_i_i_1_1_queue}}{}
