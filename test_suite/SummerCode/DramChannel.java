...
public class DramChannel
{
  ...
  public DramChannel(HashMap<String, Integer> tPs, 
                     int length)
  {
    commands = 
        new ArrayList<DramCommand>();
  ...
  {
    commands.add(0, com);
    while (commands.get(commands.size() - 
                        1).getS() + 
           lengthOfWindow < 
           com.getS())
    {
    ...
    while (itr.hasNext())
    {
      ...
      if (prev.getType().equals("CAS") && 
          now.getType().equals("CASW"))
      {
        if (now.getS() - 
            prev.getS() < 
            timingParameters.get("tCAS") + 
            timingParameters.get("tBurst") + 
            timingParameters.get("tRTRS") - 
            timingParameters.get("tCWD"))
          errors += 
              "R W a a restraint violated by \nPrev Command: " + 
              prev + 
              " \nNext Command: " + 
              now + "\n";
      }
          ...
          now.getRank())
      {
        ...
        if (now.getType().equals("CAS"))
        {
          ...
          { //R R s a
            if ((now.getS() - 
                 prev.getS()) < 
                Math.max(timingParameters.get("tBurst"), 
                         timingParameters.get("tCCD")))
              errors += 
                  "R R s a restraint violated by\nPrev Command: " + 
                  prev + 
                  "\nNext Command: " + 
                  now + 
                  "\n";
        ...
        else if (now.getType().equals("REF"))
        {
          ...
          { //F F s a
            if (now.getS() - 
                prev.getS() < 
                timingParameters.get("tRFC"))
              errors += 
                  "F F s a restraint violated by\nPrev Command: " + 
                  prev + 
                  "\nNext Command: " + 
                  now + 
                  "\n";
          ...
          { //P F s a
            if (now.getS() - 
                prev.getS() < 
                timingParameters.get("tRP"))
              errors += 
                  "P F s a restraint violated by" + 
                  (now.getS() - 
                   prev.getS() - 
                   timingParameters.get("tRP")) + 
                  "\nPrev Command: " + 
            ...
            now.getBank())
        {
          ...
          else if (now.getType().equals("CAS"))
          {
            ...
            { //A R s s
              if (now.getS() - 
                  prev.getS() < 
                  timingParameters.get("tRCD") - 
                  timingParameters.get("tAL"))
                errors += 
                    "A R s s restraint violated by\nPrev Command: " + 
                    prev + 
                    "\nNext Command: " + 
                    now + 
                    "\n";
            ...
            { //R P s s
              if
                ...
                (now.getS() - 
                 prev.getS() < 
                 timingParameters.get("tBurst") + 
                 timingParameters.get("tRTP") - 
                 timingParameters.get("tCCD"))
                errors += 
                    "R P s s restraint violated by\nPrev Command: " + 
                    prev + 
                    "\nNext Command: " + 
                    now + 
                    "\n";
            ...
            { //W P s s
              if
                ...
                (now.getS() - 
                 ...
                 timingParameters.get("tCWD") + 
                 timingParameters.get("tBurst") + 
                 timingParameters.get("tWR")) /*timingParameters.get("tAL") +*/
                  errors += 
                    "W P s s restraint violated by " + 
                    (now.getS() - 
                     prev.getS() - 
                     (timingParameters.get("tCWD") + 
                      timingParameters.get("tBurst") + 
        ...
        { //Start of check of all * * s d restraints {A A s d, P A s d}
          ...
          if (now.getType().equals("RAS"))
          {
            ...
            { //A A s d
              if (now.getS() - 
                  prev.getS() < 
                  timingParameters.get("tRRD"))
                errors += 
                    "A A s d restraint violated by\nPrev Command: " + 
                    prev + 
                    "\nNext Command: " + 
                    now + 
                    "\n";
        ...
        else if (now.getType().equals("CASW"))
        {
          ...
          { //W W d a
            if (now.getS() - 
                prev.getS() < 
                timingParameters.get("tBurst") + 
                timingParameters.get("tOST"))
              errors += 
                  "W W d a restraint violated by\nPrev Command: " + 
                  prev + 
                  "\nNext Command: " + 
                  now + 
                  "\n";
