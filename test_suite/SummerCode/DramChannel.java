	...
	public String checkTiming(DramCommand com){
		...
		while(itr.hasNext()){
			...
			if(prev.getType().equals("CAS")&&now.getType().equals("CASW")){
				if(now.getS()-prev.getS()<timingParameters.get("tCAS")+timingParameters.get("tBurst")+timingParameters.get("tRTRS")-
			...
			if(prev.getRank()==now.getRank()){
				...
				if(now.getType().equals("CAS")){
					if(prev.getType().equals("CAS")){//R R s a
						if((now.getS() - prev.getS()) < Math.max(timingParameters.get("tBurst"),timingParameters.get("tCCD")))
							errors += "R R s a restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
					}else if(prev.getType().equals("CASW")){//W R s a 
						if((now.getS() - prev.getS()) < timingParameters.get("tBurst") + timingParameters.get("tCWD") + timingParameters.get("tWTR"))
				...
				if(prev.getBank()==now.getBank()){
					...
					//Start of check of all * R s s restraints {A R s s}
						...
						if(prev.getType().equals("RAS")){//A R s s
					...
					//Start of check of all * W s s restraints {A W s s}
						...
						if(prev.getType().equals("RAS")){//A W s s
							if(now.getS() - prev.getS() < timingParameters.get("tRCD")-timingParameters.get("tAL"))
					...
					//Start of check of all * P s s restraints {A P s s, R P s s, W P s s}
						...
						if(prev.getType().equals("RAS")){//A P s s
							if(now.getS() - prev.getS() < timingParameters.get("tRAS"))
								errors += "A P s s restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
						}else if(prev.getType().equals("CAS")){//R P s s
							if(now.getS() - prev.getS() < timingParameters.get("tAL")+timingParameters.get("tBurst")+timingParameters.get("tRTP")-timingParameters.get("tCCD"))
								errors += "R P s s restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
						}else if(prev.getType().equals("CASW")){//W P s s
							if(now.getS() - prev.getS() < timingParameters.get("tAL")+timingParameters.get("tCWD")+timingParameters.get("tBurst")+timingParameters.get("tWR"))
								errors += "W P s s restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
						}
				...
				}else{//Start of check of all * * s d restraints {A A s d, P A s d}
					//Start of check of all * A s d restraitns {A A s d, P A s d}
					if(now.getType().equals("RAS")){
						if(prev.getType().equals("RAS")){//A A s d
							if(now.getS() - prev.getS() < timingParameters.get("tRRD"))
								errors += "A A s d restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
						}else if(prev.getType().equals("Pre")){//P A s d
							if(now.getS() - prev.getS() < timingParameters.get("tRP"))
								errors += "P A s d restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
						}
			...
			//End of check of all * * s * restraints
			}else{//Start of check of all * * d * restraints {R R d a, W R d a, W W d a}
				//Start of check of all * * d a restraints {R R d a, W R d a, W W d a}
				//Start of check of all * R d a restraints {R R d a, W R d a}
				if(now.getType().equals("CAS")){
					if(prev.getType().equals("CAS")){//R R d a
						if(now.getS() - prev.getS() <timingParameters.get("tBurst")+timingParameters.get("tRTRS"))
							errors += "R R d a restraint violated by\nPrevious Command: " + prev + "\nNext Command: " + now + "\n";
					}else if(prev.getType().equals("CASW")){//W R d a
						if(now.getS() - prev.getS() < timingParameters.get("tCWD")+timingParameters.get("tBurst")+timingParameters.get("tRTRS")-timingParameters.get("tCAS"))
				...
				//Start of check of all * W d a restraints {W W d a}
					...
					if(prev.getType().equals("CASW")){//W W d a
