...
\begin{CompactList}\small\item\em determines if there are enough command slots for the \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} to be decoded \item\end{CompactList}\item 
...
determines if there are enough command slots for the \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} to be decoded 
...
takes a \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} and divides it into a number of commands, depending which row buffer management policy is chosen\par
 ...
 the CAS command will contain a pointer to the host \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} to indicate that a read \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} has available data \begin{Desc}
\item[Author:]Joe Gross \end{Desc}
\begin{Desc}
\item[Parameters:]
\begin{description}
