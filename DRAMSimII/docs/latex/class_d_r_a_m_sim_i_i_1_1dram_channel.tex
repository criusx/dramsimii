...
const dramTimingSpecification \& {\bf getTimingSpecification} () const \label{class_d_r_a_m_sim_i_i_1_1dram_channel_a4ac4104d757a069a4bf66ee1666e1e9}
...
queue$<$ {\bf command} $>$ {\bf historyQueue}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_c5a60b4ef57a6bf8b6d6b84974a1eeb6}
...
\end{Desc}
\begin{Desc}
\item[Returns:]true if there was room in the queue for this \doxyref{command}{p.}{class_d_r_a_m_sim_i_i_1_1command} and the algorithm allowed it, false otherwise \end{Desc}
