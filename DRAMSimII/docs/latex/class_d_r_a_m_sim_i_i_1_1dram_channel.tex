...
Inherited by DRAMSimII::fbdChannel{\tt  [private]}.

Collaboration diagram for DRAMSimII::dramChannel:\subsection*{Public Member Functions}
...
\begin{CompactList}\small\item\em Converts a \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} in a particular channel into commands, then inserts them in the bank queues. Functionality similar to that of the memory controller moving between the \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} queue and the per bank command queues. \item\end{CompactList}\item 
command $\ast$ {\bf getNextCommand} ()
\begin{CompactList}\small\item\em Chooses the command which should be executed next from the given channel Choice is made based on command\_\-ordering\_\-algorithm from system config Command returned has already been removed from the per\_\-bank\_\-command\_\-queue from which it was selected. \item\end{CompactList}\item 
void {\bf executeCommand} (command $\ast$thisCommand, const int gap)
\begin{CompactList}\small\item\em Updates the channel time to what it would be had this command been executed Updates the rank and bank records of the most recent RAS, CAS, etc. times Enqueues RAS times to allow t\_\-faw to be determined later Updates rank and bank records of CAS, RAS lengths for later calculations in min\_\-protocol\_\-gap(). \item\end{CompactList}\item 
tick\_\-t {\bf nextTransactionDecodeTime} () const 
\begin{CompactList}\small\item\em determine when the next \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} in the queue will be decoded \item\end{CompactList}\item 
virtual tick\_\-t {\bf nextTick} () const 
\begin{CompactList}\small\item\em determines when the next \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} is decoded, command ready to be executed or next refresh command arrives \item\end{CompactList}\item 
virtual const command $\ast$ {\bf readNextCommand} () const 
...
virtual int {\bf minProtocolGap} (const command $\ast$thisCommand) const 
...
virtual tick\_\-t {\bf earliestExecuteTime} (const command $\ast$thisCommand) const 
...
\item 
void {\bf setStatistics} (dramStatistics $\ast$value)\label{class_d_r_a_m_sim_i_i_1_1dram_channel_9a64bf05caefb16fbfb887088ff803c6}

\begin{CompactList}\small\item\em set the statistics pointer to a dramStatistics object \item\end{CompactList}\item 
...
{\bf dramChannel} (const dramSettings \&settings, const dramSystemConfiguration \&sysConfig)
\begin{CompactList}\small\item\em constructs the \doxyref{dramChannel}{p.}{class_d_r_a_m_sim_i_i_1_1dram_channel} using this settings reference, also makes a reference to the dramSystemConfiguration object \item\end{CompactList}\item 
...
dramTimingSpecification {\bf timingSpecification}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_ca5241f728fec14593390cc04f4d89b5}

\begin{CompactList}\small\item\em the timing specs for this channel \item\end{CompactList}\item 
queue$<$ {\bf transaction} $>$ {\bf transactionQueue}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_fde025b97580f33ab6a7249eefce3111}

\begin{CompactList}\small\item\em \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} queue for the channel \item\end{CompactList}\item 
...
queue$<$ command $>$ {\bf historyQueue}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_c5a60b4ef57a6bf8b6d6b84974a1eeb6}

\begin{CompactList}\small\item\em what were the last N commands to this channel? \item\end{CompactList}\item 
queue$<$ {\bf transaction} $>$ {\bf completionQueue}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_e5ff742a1e3f170a56073fdf84af1804}

\begin{CompactList}\small\item\em completed\_\-q, can send status back to memory controller \item\end{CompactList}\item 
const dramSystemConfiguration \& {\bf systemConfig}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_d1262026f63598d2f81b269f0b2c9c82}

\begin{CompactList}\small\item\em a pointer to common system config values \item\end{CompactList}\item 
dramStatistics $\ast$ {\bf statistics}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_666ac5bdc34b2ecf7ef78d79bceed8da}

\begin{CompactList}\small\item\em backward pointer to the stats engine \item\end{CompactList}\item 
powerConfig {\bf powerModel}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_49959a2c6c76f5cd89d5e291b61ec66c}

\begin{CompactList}\small\item\em the power model for this channel, retains power stats \item\end{CompactList}\item 
dramAlgorithm {\bf algorithm}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_dd2db461af0f6acfe9c76648986b5d85}

\begin{CompactList}\small\item\em the algorithms used for \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction}, command, etc. ordering \item\end{CompactList}\item 
...
std::vector$<$ rank\_\-c $>$ {\bf rank}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_74cb774fccff04075a4c6b53f334266f}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}dramChannel::dramChannel (const dramSettings \& {\em settings}, const dramSystemConfiguration \& {\em sysConfig})\hspace{0.3cm}{\tt  [explicit]}}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_cdaec331a7930937338e6d13b8a5fafa}


constructs the \doxyref{dramChannel}{p.}{class_d_r_a_m_sim_i_i_1_1dram_channel} using this settings reference, also makes a reference to the dramSystemConfiguration object 
...
\item[Parameters:]
\begin{description}
\item[{\em in}]the \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} to be put into the queue \end{description}
\end{Desc}
\begin{Desc}
\item[Returns:]true if there was room in the queue for this command and the algorithm allowed it, false otherwise \end{Desc}
...
this will ensure that a given \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} can be broken into and inserted as commands in this channel if there is not room under a given scheme, then it will return false \index{DRAMSimII::dramChannel@{DRAMSimII::dramChannel}!transaction2commands@{transaction2commands}}
\index{transaction2commands@{transaction2commands}!DRAMSimII::dramChannel@{DRAMSimII::dramChannel}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}bool dramChannel::transaction2commands ({\bf transaction} $\ast$ {\em this\_\-t})}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_f0bfd23f2eaeeb89e8a0b7deb6f77b42}


Converts a \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} in a particular channel into commands, then inserts them in the bank queues. Functionality similar to that of the memory controller moving between the \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} queue and the per bank command queues. 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}command $\ast$ dramChannel::getNextCommand ()}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_d3026d3d3f3a28d838dd84f14c968a31}


Chooses the command which should be executed next from the given channel Choice is made based on command\_\-ordering\_\-algorithm from system config Command returned has already been removed from the per\_\-bank\_\-command\_\-queue from which it was selected. 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void dramChannel::executeCommand (command $\ast$ {\em thisCommand}, const int {\em gap})}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_858085111517b116cf4bbc0d83ffb5d5}


Updates the channel time to what it would be had this command been executed Updates the rank and bank records of the most recent RAS, CAS, etc. times Enqueues RAS times to allow t\_\-faw to be determined later Updates rank and bank records of CAS, RAS lengths for later calculations in min\_\-protocol\_\-gap(). 

\begin{Desc}
\item[Parameters:]
\begin{description}
\item[{\em this\_\-command}]The command to execute against the current state\item[{\em gap}]The minimum amount of time to delay before executing the command\end{description}
\end{Desc}
...
determine when the next \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} in the queue will be decoded 
...
determines when the next \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} is decoded, command ready to be executed or next refresh command arrives 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}const command $\ast$ dramChannel::readNextCommand () const\hspace{0.3cm}{\tt  [virtual]}}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_d219df39009a854f2078c57a28ef569c}


Chooses the command which should be executed next from the given channel Choice is made based on command\_\-ordering\_\-algorithm from system config Command returned is not yet removed from the per\_\-bank\_\-command\_\-queue from which it was selected. 
...
\index{DRAMSimII::dramChannel@{DRAMSimII::dramChannel}!minProtocolGap@{minProtocolGap}}
\index{minProtocolGap@{minProtocolGap}!DRAMSimII::dramChannel@{DRAMSimII::dramChannel}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int dramChannel::minProtocolGap (const command $\ast$ {\em this\_\-c}) const\hspace{0.3cm}{\tt  [virtual]}}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_629da11d3f3af08daaefa01a3838baf7}


find the protocol gap between a command and current system state 

\index{DRAMSimII::dramChannel@{DRAMSimII::dramChannel}!earliestExecuteTime@{earliestExecuteTime}}
\index{earliestExecuteTime@{earliestExecuteTime}!DRAMSimII::dramChannel@{DRAMSimII::dramChannel}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}tick\_\-t dramChannel::earliestExecuteTime (const command $\ast$ {\em currentCommand}) const\hspace{0.3cm}{\tt  [virtual]}}\label{class_d_r_a_m_sim_i_i_1_1dram_channel_0dff30a96a252de8fb413f61d3de1384}


Returns the soonest time that this command may execute. 

Looks at all of the timing parameters and decides when the this command may soonest execute \index{DRAMSimII::dramChannel@{DRAMSimII::dramChannel}!readTransaction@{readTransaction}}
...
read the next available \doxyref{transaction}{p.}{class_d_r_a_m_sim_i_i_1_1transaction} for this channel without actually removing it from the queue if bufferDelay is set, then only transactions that have been in the queue long enough to decode are considered 
