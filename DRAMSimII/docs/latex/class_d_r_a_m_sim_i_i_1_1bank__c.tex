...
\begin{CompactItemize}
\item 
queue$<$ {\bf command} $>$ {\bf perBankQueue}\label{class_d_r_a_m_sim_i_i_1_1bank__c_280594b2e337a689bcf77e18cb9705e8}

\begin{CompactList}\small\item\em the \doxyref{command}{p.}{class_d_r_a_m_sim_i_i_1_1command} priority queue, stores the commands to be executed \item\end{CompactList}\item 
