...
# ----------------------------------
m5todin_commandline = 'python m5ToDin.py trace/' + benchmark + 'Stream.gz trace/' + benchmark + '.din'
...
# ----------------------------------
l3stats_commandline = './dineroIV -informat d -l1-usize 16M -l1-ubsize 64 -l1-uassoc 16 -l1-upfdist 3 < trace/' + benchmark +'.din > stats/result/' + benchmark + '.l3.txt'
