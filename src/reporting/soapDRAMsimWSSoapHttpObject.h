...
#ifndef soapDRAMsimWSSoapHttpObject_H
#define soapDRAMsimWSSoapHttpObject_H
#include "soapH.h"
...
class DRAMsimWSSoapHttpService : public soap
{    public:
	DRAMsimWSSoapHttpService()
	{ static const struct Namespace namespaces[] =
{
	...
	virtual ~DRAMsimWSSoapHttpService() { };
