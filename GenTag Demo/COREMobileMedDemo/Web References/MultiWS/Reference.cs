...
// 
namespace COREMobileMedDemo.MultiWS {
    ...
    public partial class GetDatesWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public GetDatesWS() {
            this.Url = "http://id1.gentag.com:7777/GentagDemo/GetDatesWSSoapHttpPort";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsetItem(string String_1, string String_2, string String_3, bool boolean_4, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("setItem", new object[] {
                        String_1,
                        String_2,
                        String_3,
                        boolean_4}, callback, asyncState);
        }
