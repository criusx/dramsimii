...
namespace COREMobileMedDemo
{
    class NativeMethods
    {
        ...
        public void readLog(writeViolationsCB mycb)
        {
            ...
            {
                case -1:
                    MessageBox.Show(COREMobileMedDemo.Properties.Resources.error1);
                    break;
                case -2:
                    MessageBox.Show(COREMobileMedDemo.Properties.Resources.error2);
                    break;                
                default:
                    break;
            }
        ...
        public void readTagID()
        {
            ...
            {
                ReaderError(COREMobileMedDemo.Properties.Resources.error1);
                return;
            }
            else if (C1Lib.C1.NET_C1_enable() != 1)
            {
                C1Lib.C1.NET_C1_disable();
                ReaderError(COREMobileMedDemo.Properties.Resources.error2);
                return;
            }
            string oldTag = "";
        ...
        public static string readOneTagID()
        {
            if (C1Lib.C1.NET_C1_open_comm() != 1)
            {
                throw new NotSupportedException(COREMobileMedDemo.Properties.Resources.error1);
            }
            else if (C1Lib.C1.NET_C1_enable() != 1)
            {
                C1Lib.C1.NET_C1_disable();
                throw new NotSupportedException(COREMobileMedDemo.Properties.Resources.error2);
            }
