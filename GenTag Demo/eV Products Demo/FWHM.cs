    ...
    public partial class FWHM : Form
    {
        ...
        private void Command_CAL_Click(object sender, EventArgs e)
        {
            if (mF_Form.paintROI())
            {
                ...
                try
                {
                    chl = int.Parse(this.Text_Ch1.Text);
                    chr = int.Parse(this.Text_Ch2.Text);
                    mF_Form.chl = chl;
                    mF_Form.chr = chr;
                }
                catch (Exception)
                ...
                if (chr < 4095)
                {
                    ...
                    if (mF_Form.Check_EenergyD.Enabled == true && mF_Form.Check_EenergyD.Checked == true)
                    {
                        ...
                        arg1 = Convert.ToInt32((chl - dtemp2) / dtemp1);
                        arg2 = Convert.ToInt32((chr - dtemp2) / dtemp1);
                        mF_Form.chl = chl;
                        mF_Form.chr = chr;
                    }
                    else
