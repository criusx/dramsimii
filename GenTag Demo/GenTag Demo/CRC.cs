...
namespace GenTag_Demo
{
    class CRC
    {
        ...
        public static ushort update(byte data, ushort crc)
        {
            crc = (ushort)((crc << 8) ^ CRC16_TABLE[((crc >> 8) ^ data) & 0xff]);
            return crc;
        }
        ...
        /// <param name="crc">The starting crc value</param>
        /// <returns>The updated CRC value</returns>
        public static ushort updateBlock(byte[] data, uint len, ushort crc)
        {
            for (int i = 0; i < len; i++)
                crc = (ushort)((crc << 8) ^ CRC16_TABLE[(crc >> 8) ^ data[i]]);
            return crc;
        }
        ...
        public static ushort calc(byte[] data, int len)
        {
            ushort crc = 0;
