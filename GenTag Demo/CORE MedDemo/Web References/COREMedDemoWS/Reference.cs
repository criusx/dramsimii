...
namespace CORE_MedDemo.COREMedDemoWS {
    ...
    public partial class COREMedDemoWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void getDrugInfoAsync(string String_1, string String_2) {
            this.getDrugInfoAsync(String_1, String_2, null);
        }
        
        /// <remarks/>
        public void getDrugInfoAsync(string String_1, string String_2, object userState) {
            ...
            this.InvokeAsync("getDrugInfo", new object[] {
                        String_1,
                        String_2}, this.getDrugInfoOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void getPatientRecordAsync(string RFIDNum, string String_2) {
            this.getPatientRecordAsync(RFIDNum, String_2, null);
        }
        
        /// <remarks/>
        public void getPatientRecordAsync(string RFIDNum, string String_2, object userState) {
            ...
            this.InvokeAsync("getPatientRecord", new object[] {
                        RFIDNum,
                        String_2}, this.getPatientRecordOperationCompleted, userState);
        }
