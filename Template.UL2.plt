...
plot 'standardOutFile004-power.txt' using 1 t "Psys(ACT_STBY)[0][0]", '' using 2 t "Psys(ACT)[0][0]", '' using 3 t "P(ACT_STBY)[0][1]", '' using 4 t "Psys(ACT)[0][1]", '' using 5 t "Psys(ACT)", '' using 6 t "Psys(RD)", '' using 7 t "Psys(WR)"
